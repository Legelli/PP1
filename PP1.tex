...
\begin{table}[H]
\centering
\captionof{table}{Misure per la verifica della legge di Malus con due polarizzatori.}
\label{tab:malus1}
\begin{tabular}{cc}
\hline
 $\theta$ [deg]& I [V]\\
...
\begin{table}[H]
\centering
\captionof{table}{Misure per la verifica della legge di Malus con tre polarizzatori.}
\label{tab:malus2}
\begin{tabular}{cc}
\hline
 $\theta$ [deg]& I [V]\\
...
\begin{table}[H]
\centering
\captionof{table}{Misure di intensità utilizzando un solo polarizzatore.}
...
\begin{table}[H]
\centering
\captionof{table}{Misure per lo studio dell'angolo di Brewster: l'angolo in questo caso è quello dato dalla ghiera di rotazione della lastra, e differisce di $\theta_0 = \SI{80}{\degree}$ da quello di incidenza.}
\label{tab:brewster}
\begin{tabular}{ccc}
\hline
